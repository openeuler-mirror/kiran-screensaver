...
KiranGraphicsGlowEffect::KiranGraphicsGlowEffect(QObject *parent) :
...
void KiranGraphicsGlowEffect::draw(QPainter *painter)
{
...
// 获取有效的边界区域
QRectF KiranGraphicsGlowEffect::boundingRectFor(const QRectF &rect) const
{
